	...
	<div class="col-md-4 col-md-offset-3">
		<div class="well" style="position:relative;top:20vh;">
			<form class="form-horizontal form-custom-login" action="" method="POST">
			  <div class="form-heading" style="background: linear-gradient(#482259,#251247,#010033);">
			  ...
			  <button type="submit" name="change_password_btn" class="btn btn-default pull-right" style="background: linear-gradient(#482259,#251247,#010033); color:white">Change Password</button>
			</form>
		</div>
	</div>
</div>
