          ...
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <div class="well rounded-0">
                <h3 class="text-center bg-primary" style="padding: 7px; background: linear-gradient(#482259,#251247,#010033);">Edit Task </h3><br>
                          ...
                          <form class="form-horizontal" role="form" action="" method="post" autocomplete="off">
                            <div class="form-group">
			                  ...
			                  <div class="form-group">
			                   ...
			                   <div class="form-group">
			                    <label class="control-label text-p-reset" style="color:#452157">Status</label>
			                    <div class="">
			                      <select class="form-control rounded-0" name="status" id="status" style="color:#452157">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                <button type="submit" name="update_task_info" class="btn btn-primary-custom" style="background: linear-gradient(#482259,#251247,#010033);">Update Now</button>
                              </div>
                            </div>
                          </form> 
                        </div>
