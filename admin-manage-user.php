    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h2 class="modal-title text-center" style="color:#452157">Employee Info</h2>
        </div>
              ...
              <form role="form" action="" method="post" autocomplete="off">
                <div class="form-horizontal">
                  ...
                  <div class="form-group">
                    <label class="control-label text-p-reset" style="color:#452157">Employee Name</label>
                    <div class="">
                   ...
                   <div class="form-group">
                    <label class="control-label text-p-reset" style="color:#452157">Username</label>
                    <div class="">
                      <input type="text" placeholder="Enter Employee username" name="em_username" class="form-control input-custom" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label text-p-reset" style="color:#452157">Email Address</label>
                    <div class="">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-3">
                      <button type="submit" name="add_new_employee" class="btn btn-primary btn-sm rounded-0" style="background: linear-gradient(#482259,#251247,#010033);">Update Change</button>
                    </div>
                    <div class="col-sm-3">
                      <button type="submit" class="btn btn-default btn-sm rounded-0" data-dismiss="modal" style=" color:white; background: linear-gradient(#482259,#251247,#010033);">Cancel</button>
                    </div>
                  </div>
                </div>
              </form> 
      ...
      <div class="col-md-12">
        ...
        <div class="well well-custom">
          ...
          <?php } ?>
            <?php if($user_role == 1){ ?>
                <div class="btn-group">
                  <button class="btn btn-primary-custom btn-menu" data-toggle="modal" data-target="#myModal" style="background: linear-gradient(#482259,#251247,#010033);">Add New Employee</button>
                </div>
              <?php } ?>
            ...
            <table class="table table-codensed table-custom">
              ...
              ?>
                <tr>
                  ...
                  <td><a title="Update Employee" style="color:#452157" href="update-employee.php?admin_id=<?php echo $row['user_id']; ?>"><span class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp;<a title="Delete" style="color:#452157" href="?delete_user=delete_user&admin_id=<?php echo $row['user_id']; ?>" onclick=" return check_delete();"><span class="glyphicon glyphicon-trash"></span></a></td>
                </tr>
