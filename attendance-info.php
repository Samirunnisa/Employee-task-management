    ...
    <div class="row">
      <div class="col-md-12">
        <div class="well well-custom">
              ...
              ?>
                ...
                <div class="btn-group">
                  <form method="post" role="form" action="">
                    ...
                    <button type="submit" name="add_punch_in" class="btn btn-primary btn-lg rounded" style="background: linear-gradient(#482259,#251247,#010033);" >Clock In</button>
                  </form>
          ...
          <center><h3 style="color:white">Manage Atendance</h3>  </center>
          <div class="gap"></div>
          ...
          <div class="table-responsive">
            <table class="table table-codensed table-custom">
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <form method="post" role="form" action="">
                      ...
                      <button type="submit" name="add_punch_out" class="btn btn-danger btn-xs rounded" style="background: linear-gradient(#482259,#251247,#010033);">Clock Out</button>
                    </form>
                  </td>
                <?php }else{ ?>
                ...
                <?php if($user_role == 1){ ?>
                 <td>
                  <a style="color:#452157" title="Delete" href="?delete_attendance=delete_attendance&aten_id=<?php echo $row['aten_id']; ?>" onclick=" return check_delete();"><span class="glyphicon glyphicon-trash"></span></a>
                </td>
                <?php }else{ ?>
                <td>
                </td>
