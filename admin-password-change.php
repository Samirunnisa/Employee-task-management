          ...
          <div class="row">
            <div class="col-md-10 col-md-offset-1">
              <div class="well" style="background:#fff !important" >
                <h3 class="text-center bg-primary" style="padding: .5em!important; background: linear-gradient(#482259,#251247,#010033);">Admin - Change Password</h3><br>
                        ...
                        ?>
                          ...
                          <form class="form-horizontal" role="form" action="" method="post" autocomplete="off">
                            <div class="form-group">
                              <label class="control-label text-p-reset" style="color:#452157">Old Password</label>
                              <div class="">
                            ...
                            <div class="form-group">
                              <label class="control-label text-p-reset" style="color:#452157">New Password</label>
                              <div class="">
                            ...
                            <div class="form-group">
                              <label class="control-label text-p-reset" style="color:#452157">Confirm New Password</label>
                              <div class="">
                            ...
                            <div class="form-group">
                              <div class="col-sm-offset-4 col-sm-3">
                                <button type="submit" name="btn_admin_password" class="btn btn-primary-custom"style="background: linear-gradient(#482259,#251247,#010033);">Change</button>
                                
                              </div>
                              <div class="col-sm-3">
                                <a href="manage-admin.php" class="btn btn-default" style="color:white ; background: linear-gradient(#482259,#251247,#010033);">Cancel</a>
                              </div>
                            </div>
                          </form> 
                        </div>
