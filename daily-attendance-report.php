      ...
      <div class="col-md-12">
        <div class="well well-custom rounded-0">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
                  <button class="btn btn-primary btn-sm btn-menu" type="button" id="filter" style="background: linear-gradient(#482259,#251247,#010033);"><i class="glyphicon glyphicon-filter"></i> Filter</button>
                  <button class="btn btn-success btn-sm btn-menu" type="button" id="print" style="background: linear-gradient(#482259,#251247,#010033);"><i class="glyphicon glyphicon-print"></i> Print</button>
            </div>

            
          </div>
          <center ><h3 style="color:white">Daily Attendance Report</h3></center>
          <div class="gap"></div>
